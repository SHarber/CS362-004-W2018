...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
		Adventurer(state, currentPlayer, temphand, z, drawntreasure, cardDrawn);// Calls Adventurer Function

    case council_room:
		Council_Room(currentPlayer, state, handPos);// Calls Council_Room Function
    ...
    case smithy:
		Smithy(currentPlayer, state, handPos);// Calls Smithy Function

    case village:
		 Village(currentPlayer, state, handPos);// Calls Village Function
    ...
    case great_hall:
		Great_Hall(currentPlayer, state, handPos);// Calls Great_Hall Function
